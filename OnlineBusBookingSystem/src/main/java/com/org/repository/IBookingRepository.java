...
public interface IBookingRepository extends JpaRepository<Booking, Integer> {
	...
	public List<Booking> getAllBookingsByUserName(String userame);

	@Query(value = "Select * from Booking b where b.bdate= ?1", nativeQuery = true)
	public Booking getAllBookingByDate(LocalDate date);
